...
<div id="container" class="container sign-up">
    <div class="row">
        <!-- SIGN UP -->
        <div class="col align-items-center flex-col sign-up" style="width:100%">
            <div class="form-wrapper align-items-center">
                <form class="form sign-up" method="POST" action="{{ route('pelanggan.register.submit') }}">
                    @csrf
                    ...
                    <p>
                        ...
                        <a href="{{ route('pelanggan.login') }}" class="pointer">
                            Sign in here
                        </a>
                    </p>
                </form>
